/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=development` (hash: f5afe636b288f62239859dfe4f23760f)
// Runtime types generated with workerd@1.20260722.1 2026-07-24 
interface __BaseEnv_Env {
	DB: D1Database;
	ZILEAN_ORIGIN: "https://zileanfortheweebs.midnightignite.me";
	CONFIG_SECRET: string;
	TV_PREPARATION: Workflow<Parameters<import("./src/index").TvSchedulePreparationWorkflow['run']>[0]['payload']>;
}
